...
public class FullMouBlocTest {
    ...
    public static Collection<Object[]> data() {
        Object[][] data = new Object[][]{{(new EntradaMatriuCeles(1, 1, new CelaNum("2.1", 2.1))),
                (new EntradaMatriuCeles(2, 3, new CelaText("Hola"))), 0, 1, 3, 3, 4, 4, 2},
                {(new EntradaMatriuCeles(1, 1, new CelaNum("2.1", 2.1))),
                        (new EntradaMatriuCeles(2, 1, new CelaText("Hola"))), 1, 1, 2, 1, 0, 1, 2},
                {(new EntradaMatriuCeles(1, 1, new CelaNum("2.1", 2.1))),
                        (new EntradaMatriuCeles(2, 1, new CelaText("Hola"))), 1, 1, 2, 1, 2, 1, 2},
                {(new EntradaMatriuCeles(1, 1, new CelaNum("2.1", 2.1))),
                        (new EntradaMatriuCeles(1, 2, new CelaText("Hola"))), 1, 1, 1, 2, 1, 2, 2},
                {(new EntradaMatriuCeles(1, 1, new CelaNum("2.1", 2.1))),
                        (new EntradaMatriuCeles(1, 2, new CelaText("Hola"))), 1, 1, 1, 2, 1, 0, 2}};
    ...
    public void TestMouBloc() {
        ...
        assertSame(cela1.getCela(), full.getCela(cela1.getFila()+chF, cela1.getColumna()+chC));
        assertSame(cela2.getCela(), full.getCela(cela2.getFila()+chF, cela2.getColumna()+chC));
